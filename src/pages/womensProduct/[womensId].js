...
export default function Home({ womensCloth }) {
  if (!womensCloth) {
...
export async function getStaticPaths() {
  ...
  const paths = womensCloth.map((womenElem) => {
    return {
      params: {
        womensId: womenElem.id.toString(),
      },
    };
  });
